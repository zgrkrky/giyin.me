...
import { generateModelImage, uploadOriginalImage } from '../services/geminiService';
...
const StartScreen: React.FC<StartScreenProps> = ({ onModelFinalized }) => {
 ...
 const handleFileSelect = useCallback(async (file: File) => {
    ...
    reader.onload = async (e) => {
        ...
        setError(null);
        try {
            // Orijinal resmi arka planda sunucumuza yüklüyoruz
            uploadOriginalImage(file);

            // AI modelini çağırıp sonucu alıyoruz
          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              <h1 className="text-5xl md:text-6xl font-serif font-bold text-gray-900 leading-tight">
                Model Sensin Dilediğini Dene!
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Bir kıyafetin üzerinde nasıl duracağını artık düşünme. Fotoğrafını yükle ve gör. Yapay zekamız, her şeyi denemeye hazır kişisel modelini oluşturur.
              </p>
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Aydınlık ve net bir fotoğraf çek. En iyi sonucu sade, boydan ve vücut hatlarının belirgin olduğu bir fotoğrafla alırsın.</p>
          ...
          <div className="md:w-1/2 flex-shrink-0 flex flex-col items-center md:items-start">
            <div className="text-center md:text-left">
              ...
              <p className="mt-2 text-md text-gray-600">
                Kaydırma çubuğunu hareket ettirerek dönüşümünü gör.
              </p>
            </div>
            ...
            {isGenerating && (
              <div className="flex items-center gap-3 text-lg text-gray-700 font-serif mt-6">
                <Spinner />
                <span>Modelin hazırlanıyor...</span>
              </div>
            )}

            {error && 
              <div className="text-center md:text-left text-red-600 max-w-md mt-6">
                <p className="font-semibold">Dönüşüm Gerçekleşmedi 🤷🏻‍♀️</p>
